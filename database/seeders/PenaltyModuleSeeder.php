...
class PenaltyModuleSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $schedules = [
            ...
            [
                'name_am'     => 'ህገ-ወጥ መሬት ወረራ እና ህገ-ወጥ ግንባታ',
                'name_en'     => 'Illegal Land Seizure and Construction',
                'level'       => 1,
            ...
            [
                'name_am'     => ' ህገ-ወጥ ጠጣር/ፍሳሽ ቆሻሻ ማስወገድ',
                'name_en'     => ' Illegal Solid/Sewage Waste Disposal',
                'level'       => 2,
                'description' => 'ደንብ 150/2023',
                'violations'  => [
            ...
            [
                'name_am'     => ' ትራፊክ እና የመንገድ ደህንነት',
                'name_en'     => 'Traffic and Road Safety',
                'level'       => 3,
                'description' => 'ደንብ 150/2023',
                'violations'  => [
            ...
            [
                'name_am'     => ' ህገ-ወጥ ውጭ ማስታወቂያ',
                'name_en'     => 'Illegal Outdoor Advertisements',
                'level'       => 4,
                'description' => 'ደንብ 150/2023',
                'violations'  => [
            ...
            [
                'name_am'     => 'ህገ-ወጥ እንስሳ ዝውውር/ሽያጭ/ምርስ',
                'name_en'     => 'Illegal Animal Circulation, Trading and Slaughtering',
                'level'       => 6,
                'description' => 'ደንብ 150/2023',
                'violations'  => [
            ...
            [
                'name_am'     => 'የወንዝ ዳርቻ ልማት እና ብክለት መከላከል',
                'name_en'     => ' Riverbank Development and Pollution Prevention',
                'level'       => 7,
